            ...
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button class="btn btn-warning" type="button" id="btnVaciar" onClick="redirect()">Vaciar Carrito</button>
                        <button onclick="RealizarPago()"class="btn btn-warning" type="button" id="btnPagar">Pagar carrito</button>
                    </div>
                </div>
            </div>
        </div>
